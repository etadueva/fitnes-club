...
/* harmony import */ var _modules_tuch_event__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/tuch-event */ "./js/modules/tuch-event.js");
/* harmony import */ var _modules_disable_tyles_nojs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/disable-tyles-nojs */ "./js/modules/disable-tyles-nojs.js");
...
var swiper = new Swiper('.swiper-coaches', {
  loop: true,
  navigation: {
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_disable_tyles_nojs__WEBPACK_IMPORTED_MODULE_3__["disableStylesNojs"])();
  Object(_modules_video__WEBPACK_IMPORTED_MODULE_1__["setupVideo"])();
  Object(_modules_tuch_event__WEBPACK_IMPORTED_MODULE_2__["showCard"])();
...
/***/ "./js/modules/disable-tyles-nojs.js":
/*!******************************************!*\
  !*** ./js/modules/disable-tyles-nojs.js ***!
  \******************************************/
/*! exports provided: disableStylesNojs */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "disableStylesNojs", function() { return disableStylesNojs; });
var disableStylesNojs = function disableStylesNojs() {
  var coachesList = document.querySelector('.coaches__list');
  coachesList.classList.remove('coaches__list--nojs');
  var coachesButtonPref = document.querySelector('.coaches__item-button-prev');
  coachesButtonPref.classList.remove('coaches__item-button-prev--nojs');
  var coachesButtonNext = document.querySelector('.coaches__item-button-next');
  ...
  var reviewsButtonPref = document.querySelector('.reviews__button-prev');
...
var buttons = document.querySelectorAll('.coaches__button-cover');
var itemsContent = document.querySelectorAll('.coaches__item-content');
var showCard = function showCard() {
  var _loop = function _loop(i) {
    var indexButton = i;
    var button = buttons[i];
    button.addEventListener('click', function () {
      for (var j = 0; j <= itemsContent.length; j++) {
        var indexContent = j;
        var itemContent = itemsContent[j];
